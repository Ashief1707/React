...
const AuthLayout = (props) => {
  ...
  const { isDarkMode, toggleTema } = useTema(); 

  return (
    <div
      className={`flex justify-center min-h-screen items-center ${
        isDarkMode ? "bg-gray-800 text-white" : "bg-special-mainBg text-gray-500"
      }`}
    >
      ...
      >
        ...
        {(type === "signin" || type === "signup") && (
          <div className="my-9 px-7 flex justify-center text-xs text-gray-03 items-center flex-col static">
            ...
            <div className={`px-2 absolute ${isDarkMode ? "bg-gray-800 text-white" : "bg-special-mainBg text-gray-400"}`}>or sign in with</div>
          </div>
        )}
        {/* teks end */}
          ...
          {type === "signin" ? (
            <div className="flex flex-col">
              ...
              <div className="flex justify-center mt-3">
                <Link to="/forgotpassword" className="text-gray-02 text-sm font-bold">
                  Forgot Password
                </Link>
              </div>
            </div>
            ...
            <Link to="/login" className="text-gray-500 text-sm font-bold">
              Back to login
            </Link>
          )}
        </div>
